...
const regForMob = RegExp(/^(\+\d{1,3}[- ]?)?\d{10}$/);
                            ...
                            <div className='card1'>
                                ...
                                <Form >
                                    ...
                                    <Form.Group as={Row} className="mb-3">
                                        ...
                                        <Col sm="8">
                                            <Form.Control type="text" placeholder="Enter Email" name="email" disabled="disabled" defaultValue={user.email} 
                                    ...
                                    <Form.Group as={Row} className="mb-3">
                                        ...
                                        <Col sm="8">
                                            ...
                                            {mobile != '' && !regForMob.test(mobile)
                                                && <span className="text-danger">Enter Mobile number correctly</span>}
                                        </Col>
                                    </Form.Group>
